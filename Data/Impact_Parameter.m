...
[Coeff_14321]=polyfit(good_xaxis1_14321,logy_proj_14321,1);
lambda_14321=-Coeff_14321(1);

Exp_yproj_14321=A_14321*exp(-lambda_14321*(good_xaxis1_14321-a_14321*res_14321));

a_total_14321=a_total_14321+a_14321*res_14321;
A_total_14321=A_total_14321+A_14321;

end

IP_ODR_14321=a_total_14321/n_imgs_14321;
Peak_yIntens_14321=A_total_14321/n_imgs_14321;

figure(2);
plot(xaxis1_14321,y_projection_14321(shot,:));
hold on;
plot(good_xaxis1_14321,Exp_yproj_14321,'-r');
...
[Coeff_14322]=polyfit(good_xaxis1_14322,logy_proj_14322,1);
lambda_14322=-Coeff_14322(1);

Exp_yproj_14322=A_14322*exp(-lambda_14322*(good_xaxis1_14322-a_14322*res_14322));

a_total_14322=a_total_14322+a_14322*res_14322;
A_total_14322=A_total_14322+A_14322;

end

IP_ODR_14322=a_total_14322/n_imgs_14322;
Peak_yIntens_14322=A_total_14322/n_imgs_14322;

figure(3);
plot(xaxis1_14322,y_projection_14322(shot,:));
hold on;
plot(good_xaxis1_14322,Exp_yproj_14322,'-r');
title('Projected y Intensity (ODR)');
xlabel('y (microns)');
ylabel('Intensity');
hold off;
...
[Coeff_14323]=polyfit(good_xaxis1_14323,logy_proj_14323,1);
lambda_14323=-Coeff_14323(1);

Exp_yproj_14323=A_14323*exp(-lambda_14323*(good_xaxis1_14323-a_14323*res_14323));

a_total_14323=a_total_14323+a_14323*res_14323;
A_total_14323=A_total_14323+A_14323;

end

IP_ODR_14323=a_total_14323/n_imgs_14323;
Peak_yIntens_14323=A_total_14323/n_imgs_14323;

figure(4);
plot(xaxis1_14323,y_projection_14323(shot,:));
hold on;
plot(good_xaxis1_14323,Exp_yproj_14323,'-r');
title('Projected y Intensity (ODR)');
xlabel('y (microns)');
ylabel('Intensity');
hold off;
...
[Coeff_14317]=polyfit(good_xaxis1_14317,logy_proj_14317,1);
lambda_14317=-Coeff_14317(1);

Exp_yproj_14317=A_14317*exp(-lambda_14317*(good_xaxis1_14317-a_14317*res_14317));

a_total_14317=a_total_14317+a_14317*res_14317;
A_total_14317=A_total_14317+A_14317;

end

IP_ODR_14317=a_total_14317/n_imgs_14317;
Peak_yIntens_14317=A_total_14317/n_imgs_14317;

figure(6);
plot(xaxis1_14317,y_projection_14317(shot,:));
hold on;
plot(good_xaxis1_14317,Exp_yproj_14317,'-r');
title('Projected y Intensity (ODR)');
xlabel('y (microns)');
ylabel('Intensity');
hold off;
...
[Coeff_14318]=polyfit(good_xaxis1_14318,logy_proj_14318,1);
lambda_14318=-Coeff_14318(1);

Exp_yproj_14318=A_14318*exp(-lambda_14318*(good_xaxis1_14318-a_14318*res_14318));

a_total_14318=a_total_14318+a_14318*res_14318;
A_total_14318=A_total_14318+A_14318;

end

IP_ODR_14318=a_total_14318/n_imgs_14318;
Peak_yIntens_14318=A_total_14318/n_imgs_14318;

figure(7);
plot(xaxis1_14318,y_projection_14318(shot,:));
hold on;
plot(good_xaxis1_14318,Exp_yproj_14318,'-r');
title('Projected y Intensity (ODR)');
xlabel('y (microns)');
ylabel('Intensity');
hold off;
...
[Coeff_14319]=polyfit(good_xaxis1_14319,logy_proj_14319,1);
lambda_14319=-Coeff_14319(1);

Exp_yproj_14319=A_14319*exp(-lambda_14319*(good_xaxis1_14319-a_14319*res_14319));

a_total_14319=a_total_14319+a_14319*res_14319;
A_total_14319=A_total_14319+A_14319;

end

IP_ODR_14319=a_total_14319/n_imgs_14319;
Peak_yIntens_14319=A_total_14319/n_imgs_14319;

figure(8);
plot(xaxis1_14319,y_projection_14319(shot,:));
hold on;
plot(good_xaxis1_14319,Exp_yproj_14319,'-r');
title('Projected y Intensity (ODR)');
xlabel('y (microns)');
ylabel('Intensity');
hold off;
